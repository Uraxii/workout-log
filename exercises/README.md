...
- `aliases.json`. Typed shorthand to `name`, 137 entries. Every alias resolves
...
- `weight_reps`. Weight and repetitions. 55 rows.
...
103 rows, not the 913 in the database it draws from. It carries what the
...
Unlicense. 48 are written for this project, closing the gaps in
