---
name: mental-skills
description: Getting them to keep turning up. Adherence, motivation, how a missed session gets handled, and how hard to push. Wear this when sessions start getting missed, and every time you are tempted to write a better program instead of a smaller one.
---

# Mental skills

In plain words: the best program ever written is worth nothing if they stop
coming.
...
- One missed session is data. It changes nothing.
- Three in a row is a message about the plan, not about them.
