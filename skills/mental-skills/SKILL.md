---
name: mental-skills
description: Keeping them turning up. Adherence, motivation, missed sessions, how hard to push. Wear when sessions get missed, and whenever you are tempted to write a better program instead of a smaller one.
---
