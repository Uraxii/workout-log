...
In plain words: this is how you work out what somebody can do right now,
without turning their first session into an exam.

## The rule that decides everything else

Test only what would change the program.
A test whose result you already know, or would not act on, is a session they
spent not training.

## What to take at the start
...
- If their body is changing for a reason that is not training, hormones most
  obviously, the note you write has to say so.
  Lean mass falling about 5% in a trans woman's first year is the treatment
  working, not the program failing, and muscle gained in a trans man's first
  year is partly the hormone (Wiik 2020, doi:10.1210/clinem/dgz247).

## How to find a working weight

- Warm up, then add load until a set of about five feels hard but still clean.
  Stop there.
...
- At the end of a block, four to six weeks.
- Only the things that decide what the next block looks like.
- Same movement, same equipment, same rough time of day. A number measured a
  different way is a different number.
